...
const FindNumbers = () => {
    for (let currentIndex = 0; currentIndex < numberArray.length; currentIndex++) {
        ...
        const currentNumber = numberArray[currentIndex];
    
        for (let index = currentIndex; index < numberArray.length; index++) {
            const nextNumber = numberArray[index];
